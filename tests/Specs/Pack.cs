...
namespace tests.Specs
{
    ...
    $@"{{
        ...
        [Fact]
        public void Data_WithRelatedPackages_CircularReference()
        {
            KeyValuePair<string, string> packageRoot = new("Cmf.Custom.Package", "1.1.0");
            KeyValuePair<string, string> packageDep1 = new("Cmf.Custom.Data", "1.1.0");
            KeyValuePair<string, string> packageDep2 = new("Cmf.Custom.Data.Related", "1.1.0");
            ...
            var fileSystem = new MockFileSystem(new Dictionary<string, MockFileData>
            {
                ...
                { "/repo/Cmf.Custom.Data.Related/cmfpackage.json", new MockFileData(
                @$"{{
                  ""packageId"": ""{packageDep2.Key}"",
                  ""version"": ""{packageDep2.Value}"",
                  ""packageType"": ""Data"",
                  ...
                  ""relatedPackages"": [
                    {{
                        ""path"": ""../Cmf.Custom.Data"",
                        ""prePack"": true
                    }}
                  ]
                }}")},
                { "/repo/Cmf.Custom.Data/folder1/file1.txt", new MockFileData("file1-content")},
                { "/repo/Cmf.Custom.Data.Related/folder2/file2.txt", new MockFileData("file2-content")},
            });
            ...
            ExecutionContext.RelatedPackagesCache.ForEach(rp => rp.IsProcessed.Should().BeTrue());
